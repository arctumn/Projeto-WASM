...
unsigned long long *rsa_encrypt(const char *message, const unsigned long message_size, 
...
char *rsa_decrypt(const unsigned long long *message, 
                  ...
                  const struct private_key_class *priv)
{
  ...
  // (decrypted)
  char *decrypted = malloc(message_size/sizeof(unsigned long long));
